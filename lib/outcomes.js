// lib/outcomes.js
// Lints outcomes for: banned verbs, leading verb, measurability, single action, and concise length.
...
export function lintOutcomes(outcomes = []) {
  return outcomes.map((o) => {
    ...
    const multiAction = /\b(and then|, then|; then| and |;|, and )\b/i.test(text); // simple chain check
